...
\todo{\ada{For the case in which only information of time is provided or where a cone search is not representing the location of a source (e.g. GW and neutrinos) we should relax this parameter to say something refering to unlocated space. How do we do this?}}
