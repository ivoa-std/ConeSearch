...
available \ada{couln't find it}} and then transcripted into an IVOA standards document format
...
\todo{\ada{Acknowledge the ESCAPE project.}} 
...
\todo{\ada{Do we need to add here something about the fact that sometimes services will provide time and sometimes not?}}
...
\todo{\ada{Added here the time, please check that}}
\begin{lstlisting}[language=XML,basicstyle=\footnotesize]
...
\todo{\ada{shouldn't we change the example to VOTable 1.4}}

\ada{This is an example of a legal response to a Cone Search query using the time parameter:}
\todo{\ada{Can you check this please?}}
\begin{lstlisting}[language=XML,basicstyle=\footnotesize]
...
<VOTABLE version="1.4" xmlns="http://www.ivoa.net/xml/VOTable/v1.3">
  ...
  <TABLE name="data">
    <FIELD name="ra" datatype="double" unit="degree" ucd="pos.eq.ra;meta.main" ref="system"> 
      <DESCRIPTION> Right Ascension </DESCRIPTION>
    </FIELD>
    <FIELD name="dec" datatype="double" unit="degree" ucd="pos.eq.dec;meta.main" ref="system"> 
      <DESCRIPTION> Right Ascension </DESCRIPTION>
    </FIELD>
    <FIELD name="time" datatype="double" unit="d" ucd="time.epoch;meta.main" ref="time_frame"> 
    ...
    <FIELD name="mag" datatype="float" ucd="phot.mag;em.opt.V" unit="mag"/>
      ...
      <TABLEDATA>
        <TR>270.14754119086</TD>
        <TR>-30.90475459580</TD>
        <TD>2309.00199864</TD>
        <TD>18.990655</TD>
      </TABLEDATA>
    </DATA>
...
\begin{itemize}[noitemsep]
	\item \ada{added the extension for time search.} 
